...
(.venv) python -m corebehrt.main.select_cohort --config_path corebehrt/configs/select_test_cohort.yaml
...
(.venv) python -m corebehrt.main.prepare_training_data --config_path corebehrt/configs/prepare_all.yaml
